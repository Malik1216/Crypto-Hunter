...
class Controller extends BaseController
{
    ...
    */
	public function dashboard(Request $request)
    {
        ...
        }elseif($settings->payment_mode=='USDT'){
          $condition=empty(Auth::user()->usdt_address) or empty(Auth::user()->phone);
        }else{
        ...
        //'earnings'=>$earnings,
        'title'=>'User panel',
        'withdrawals' => withdrawals::where('user', Auth::user()->id)->orderBy('id', 'desc')->get(),
        'deposits' => deposits::where('user', Auth::user()->id)->orderBy('id', 'desc')->get(),
