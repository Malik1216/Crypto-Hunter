...
trait CPTrait{
  ...
  /*return view('payment')
	    ...
	    echo'
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no" /><link href="'.asset('css/bootstrap.css').'" rel="stylesheet"><style type="text/css">.nm{margin: 150px;} @media only screen and (max-width: 480px) {.nm{vertical-align: middle;display: table-cell;}h1{font-size:25px !important;} </style>
    <script src="https://code.jquery.com/jquery.js"></script>
    <script src="'.asset('js/bootstrap.min.js').'"></script>';
    return('<div class="nm" style="border:1px solid #f2f2f2; padding:10px; color:#d0d0d0; text-align:center;"><h1 class="title">You will be redirected to your payment page!</h1>
