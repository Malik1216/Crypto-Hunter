...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ $settings->site_address}}/home/images/{{$settings->favicon}}">
    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-center">
        <div class="col-xl-11 d-flex align-items-center">
            <a href="#intro" class="logo mr-auto"><img src="{{ $settings->site_address}}/home/images/{{$settings->logo}}" alt="{{$settings->site_name}}" title="" class="img-fluid" /></a>
      ...
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox"  >
          ...
          <div class="carousel-item active">
            <div class="carousel-background"><img src="{{ $settings->site_address}}/home/images/{{$content->getImage('57VnOE','img_path')}}" alt="" class="img-h"></div>
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="{{ $settings->site_address}}/home/images/{{$content->getImage('dC6ZaA','img_path')}}" alt="" class="img-h"></div>
            <div class="carousel-container">
              <div class="carousel-content">
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="{{ $settings->site_address}}/home/images/{{$content->getImage('9kHash','img_path')}}" alt="" class="img-h"></div>
            <div class="carousel-container">
              <div class="carousel-content">
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="{{ $settings->site_address}}/home/images/{{$content->getImage('CcW52g','img_path')}}" alt="" class="img-h"></div>
            <div class="carousel-container">
              <div class="carousel-content">
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="{{ $settings->site_address}}/home/images/{{$content->getImage('96i7xH','img_path')}}" alt="" class="img-h"></div>
            <div class="carousel-container">
              <div class="carousel-content">
                ...
                <div class="pricing-box">
                  ...
                  <div class="price-list">
                    <ul class="list-unstyled">
                      ...
                      <li class="list-item"><i class="bx bx-check"></i>{{$plan->expiration}}</li>
                    </ul>
                  </div>
    ...
    <section id="transaction" class="transaction">
      <div class="container">
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-6">
                <img src="{{ $settings->site_address}}/home/imga.jpg" class="img img-fluid" style="height: 458px">
            </div>
        </div>
      </div>
    </section>
    ...
    <section id="payments" class="wow fadeInUp">
      <div class="container">
        ...
        <div class="owl-carousel payments-carousel">
          ...
          <img src="{{ asset('temp/img/payments/payment-4.png')}}" alt="">
          <img src="{{ asset('temp/img/payments/payment-9.png')}}" alt="">
