...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo e($settings->site_address); ?>/home/images/<?php echo e($settings->favicon); ?>">
    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-center">
        <div class="col-xl-11 d-flex align-items-center">
            <a href="#intro" class="logo mr-auto"><img src="<?php echo e($settings->site_address); ?>/home/images/<?php echo e($settings->logo); ?>" alt="<?php echo e($settings->site_name); ?>" title="" class="img-fluid" /></a>
      ...
      <div id="introCarousel" class="carousel  slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox"  >
          ...
          <div class="carousel-item active">
            <div class="carousel-background"><img src="<?php echo e($settings->site_address); ?>/home/images/<?php echo e($content->getImage('57VnOE','img_path')); ?>" alt="" class="img-h"></div>
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="<?php echo e($settings->site_address); ?>/home/images/<?php echo e($content->getImage('dC6ZaA','img_path')); ?>" alt="" class="img-h"></div>
            <div class="carousel-container">
              <div class="carousel-content">
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="<?php echo e($settings->site_address); ?>/home/images/<?php echo e($content->getImage('9kHash','img_path')); ?>" alt="" class="img-h"></div>
            <div class="carousel-container">
              <div class="carousel-content">
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="<?php echo e($settings->site_address); ?>/home/images/<?php echo e($content->getImage('CcW52g','img_path')); ?>" alt="" class="img-h"></div>
            <div class="carousel-container">
              <div class="carousel-content">
          ...
          <div class="carousel-item">
            <div class="carousel-background"><img src="<?php echo e($settings->site_address); ?>/home/images/<?php echo e($content->getImage('96i7xH','img_path')); ?>" alt="" class="img-h"></div>
            <div class="carousel-container">
              <div class="carousel-content">
                ...
                <div class="pricing-box">
                  ...
                  <div class="price-list">
                    <ul class="list-unstyled">
                      ...
                      <li class="list-item"><i class="bx bx-check"></i><?php echo e($plan->expiration); ?></li>
                    </ul>
                  </div>
    ...
    <section id="transaction" class="transaction">
      <div class="container">
        ...
        <div class="row mt-4">
                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo e($statistic->trading_deposit); ?></td>
                      </tr>
                      <tr>
                        <td scope="row">Total Trading Days </td>
                        <td><?php echo e($statistic->trading_days); ?></td>
                      </tr>
                      <tr>
                        <td scope="row">Daily profit in Forex</td>
                        <td><?php echo e($statistic->forex); ?></td>
                      </tr>
                      <tr>
                        <td scope="row">Daily Profit in Crypto</td>
                        <td><?php echo e($statistic->crypto); ?></td>
                      </tr>
                      <tr>
                        <td scope="row">Daily Profit in Stocks</td>
                        <td><?php echo e($statistic->stock); ?></td>
                      </tr>
                      <tr>
                        <td scope="row">Average Daily Profit </td>
                        <td><b><?php echo e($statistic->profit); ?></b></td>
                      </tr>
                      <tr>
                        <td scope="row">Weekly Profit in Holding</td>
                        <td><b><?php echo e($statistic->wprofit); ?></b></td>
                      </tr>
                      <tr>
                        <td scope="row">Drawdown </td>
                        <td><?php echo e($statistic->drawdown); ?></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
            ...
            <div class="col-md-6">
                <img src="<?php echo e($settings->site_address); ?>/home/imga.jpg" class="img img-fluid" style="height: 458px">
            </div>
        </div>
      </div>
    </section>
    ...
    <section id="payments" class="wow fadeInUp">
      <div class="container">
        ...
        <div class="owl-carousel payments-carousel">
          ...
          <img src="<?php echo e(asset('temp/img/payments/payment-4.png')); ?>" alt="">
          <img src="<?php echo e(asset('temp/img/payments/payment-9.png')); ?>" alt="">
