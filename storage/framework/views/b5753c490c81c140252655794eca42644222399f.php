                    ...
                    <div class="row mb-5">
                        <div class="col-12 p-3">
                            <a href="#"  data-toggle="modal" data-target="#faqmodal" class="btn btn-<?php echo e($text); ?>"><i class="fa fa-plus"></i> Add FAQ</a>
                                ...
                                <!--  -->
                                 <a href="#"  data-toggle="modal" data-target="#statmodal" class="btn btn-<?php echo e($text); ?>"><i class="fa fa-plus"></i> Add Statistics</a>
                                <div id="statmodal" class="modal fade" role="dialog">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                        <div class="modal-header bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>">
                                            <h4 class="modal-title" style="text-align:center;">Add Statistics</h4>
                                            <button type="button" class="close text-<?php echo e($text); ?>" data-dismiss="modal">&times;</button>
                                        </div>
                                        <div class="modal-body bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>">
                                            <form action="<?php echo e(route('savefaq')); ?>" method="POST">
                                                ...
                                                <div class="form-group">
                                                    <h5 class="text-<?php echo e($text); ?>">Total deposit</h5>
                                                    <input type="text" name="trading_deposit" placeholder="Enter the Question here" class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>" required value="<?php echo e($statistic->trading_deposit); ?>">
                                                </div>
                                                <div class="form-group">
                                                    <h5 class="text-<?php echo e($text); ?>">Trading days</h5>
                                                    <input type="text" name="trading_days" placeholder="Enter the Question here" class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>" required value="<?php echo e($statistic->trading_day); ?>">
                                                </div>
                                                <div class="form-group">
                                                    <h5 class="text-<?php echo e($text); ?>">Daily profit in forex</h5>
                                                    <input type="text" name="forex" placeholder="Enter the Question here" class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>" required value="<?php echo e($statistic->forex); ?>">
                                                </div>
                                                <div class="form-group">
                                                    <h5 class="text-<?php echo e($text); ?>">Daily profit in crypto</h5>
                                                    <input type="text" name="crypto" placeholder="Enter the Question here" class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>" required value="<?php echo e($statistic->crypto); ?>">
                                                </div>
                                                <div class="form-group">
                                                    <h5 class="text-<?php echo e($text); ?>">Daily profit in stocks</h5>
                                                    <input type="text" name="stocks" placeholder="Enter the Question here" class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>" required value="<?php echo e($statistic->stock); ?>">
                                                </div>
                                                <div class="form-group">
                                                    <h5 class="text-<?php echo e($text); ?>">Average daily profit</h5>
                                                    <input type="text" name="profit" placeholder="Enter the Question here" class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>" required value="<?php echo e($statistic->profit); ?>">
                                                </div>
                                                <div class="form-group">
                                                    <h5 class="text-<?php echo e($text); ?>">Weekly profit in holding</h5>
                                                    <input type="text" name="wprofit" placeholder="Enter the Question here" class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>" required value="<?php echo e($statistic->wprofit); ?>">
                                                </div>
                                                <div class="form-group">
                                                    <h5 class="text-<?php echo e($text); ?>">Drawdown</h5>
                                                    <input type="text" name="drawdown" placeholder="Enter the Question here" class="form-control bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?> text-<?php echo e($text); ?>" required value="<?php echo e($statistic->drawdown); ?>">
                                                </div>
