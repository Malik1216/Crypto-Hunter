        ...
        <div class="main-panel bg-<?php echo e($bg); ?>">
            <div class="content bg-<?php echo e($bg); ?>">
                <div class="page-inner">
                    <div class="mt-2 mb-4">
                        <h1 class="title1 text-<?php echo e($text); ?>">Refer friends to <?php echo e($settings->site_name); ?> community</h1>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-12 text-center card bg-<?php echo e($bg); ?> shadow-lg p-3 text-<?php echo e($text); ?>">
                            <strong>You can refer friends by sharing your referral link:</strong><br>
