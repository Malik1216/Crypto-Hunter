                    ...
                    <div class="card bg-<?php echo e($bg); ?> shadow text-<?php echo e($text); ?>">
                      <div class="card-body">
                        <h4>
                          ...
                          <strong>USDT</strong>
                          <img src="<?php echo e(asset('home/images/usdt.png')); ?>" width="40px;" height="40px;">
                          </a>
                        </h4>
                        <div id="usdt" class="panel-collapse collapse">
                          <div class="">
                            <h4 class="text-<?php echo e($text); ?>">
                            <strong>USDT Address:</strong> <?php echo e($settings->usdt_address); ?>

                            
                            <br/><br/>
                            <?php if($settings->withdrawal_option != "manual"): ?>
                            <a href="<?php echo e(url('dashboard/cpay')); ?>/<?php echo e($amount); ?>/USDT.TRC20/<?php echo e(Auth::user()->id); ?>/new" class="btn btn-<?php echo e($text); ?>">Automatic payment method</a>
                            <?php endif; ?>
                            </h4>
                          </div>
                        </div>
